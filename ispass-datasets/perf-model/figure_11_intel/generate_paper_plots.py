...
AMD_PRIMITIVE_EVENT_CSV                         = f"{CSV_DIR}/amd/primitives/primitive-results-timings-invalid.csv"
AMD_PRIMITIVE_SEC_STD_CSV                       = f"{CSV_DIR}/amd/primitives/primitive-results-sec-standard-timings-invalid.csv"
AMD_PRIMITIVES_HARDWARE_BACKEND_CSV             = f"{CSV_DIR}/amd/primitives/primitive-results-ispass-hexl-data.csv"
INTEL_PRIMITIVE_NO_SEC_STD_RUNTIME_CSV          = f"{CSV_DIR}/intel/primitives/primitive-results.csv"
INTEL_PRIMITIVE_EVENT_CSV                       = f"{CSV_DIR}/intel/primitives/primitive-results.csv"
# AMD_PRIMITIVE_RUNTIME_CSV                       = f"{CSV_DIR}/primitive-results-AMD-06-08-2025-corrected-timings.csv"
# AMD_PRIMITIVE_EVENT_CSV                         = f"{CSV_DIR}/primitive-results-amd-dataset-5-25-2025-timings-invalid.csv"
# AMD_PRIMITIVE_SEC_STD_CSV                       = f"{CSV_DIR}/primitive-results-amd-dataset-sec-standard-5-27-2025-timings-invalid.csv"
# AMD_PRIMITIVES_HARDWARE_BACKEND_CSV             = "/home/co224015/CryptOracle/out/csv/primitive-results-ispass-hexl-data.csv"
# INTEL_PRIMITIVE_NO_SEC_STD_RUNTIME_CSV          = f"{CSV_DIR}/intel_csv/primitive-results-Intel-Di-06-24-2025-figure-5-7.csv"
# INTEL_PRIMITIVE_EVENT_CSV                       = f"{CSV_DIR}/intel_csv/primitive-results-Intel-Di-06-24-2025-figure-5-7.csv"

# Microbenchmark Data
AMD_MICROBENCH_CSV                              = f"{CSV_DIR}/amd/microbenchmarks/microbenchmark-results.csv"
AMD_MICROBENCH_SEC_STD_CSV                      = f"{CSV_DIR}/amd/microbenchmarks/microbenchmarks-security-standards.csv"
AMD_MICROBENCH_MATMUL_SIZES_CSV                 = f"{CSV_DIR}/amd/microbenchmarks/microbenchmarks-different-sized-matrices.csv"
INTEL_MICROBENCH_SEC_STD_CSV                    = f"{CSV_DIR}/intel/microbenchmarks/microbenchmark-results.csv"
INTEL_MICROBENCH_NO_SEC_STD_CSV                 = f"{CSV_DIR}/intel/microbenchmarks/microbenchmark-results.csv"
# AMD_MICROBENCH_CSV                              = f"{CSV_DIR}/microbenchmark-results-amd-dataset-5-25-2025-timing-corrected.csv"
# AMD_MICROBENCH_SEC_STD_CSV                      = f"{CSV_DIR}/microbenchmark-results-amd-dataset-sec-standard-5-27-2025-timing-corrected.csv"
# AMD_MICROBENCH_MATMUL_SIZES_CSV                 = f"{CSV_DIR}/microbenchmark-results-amd-dataset-matrix-sizes-05-30-2025-timing-corrected.csv"
# INTEL_MICROBENCH_SEC_STD_CSV                    = f"{CSV_DIR}/intel_csv/microbenchmark-results-Intel-Di-06-24-2025-figure-5-7.csv"
# INTEL_MICROBENCH_NO_SEC_STD_CSV                 = f"{CSV_DIR}/intel_csv/microbenchmark-results-Intel-Di-06-24-2025-figure-5-7.csv"
...
# AMD_WORKLOAD_CSV                                = f"{CSV_DIR}/workload-results-AMD-06-08-2025-workloads-no-resnet.csv"
# AMD_RESNET_CSV                                  = f"{CSV_DIR}/workload-results-resnet-AMD-06-13-2025.csv"
# AMD_CHI_SQUARE_CSV                              = f"{CSV_DIR}/workload-results-AMD-06-25-2025-chi-square.csv"
...
# MATMUL_ESTIMATED_RUNTIME_CSV                            = "additive-model-results/matmul/estimated_matrix_multiplication_Time_median.csv"
# LOGISTIC_FUNCTION_ESTIMATED_RUNTIME_CSV                 = "additive-model-results/logistic_function/estimated_logistic_function_Time_median.csv"
# SIGN_EVAL_ESTIMATED_RUNTIME_CSV                         = "additive-model-results/sign_eval/estimated_sign_eval_Time_median.csv"

# MATMUL_ESTIMATED_ENERGY_CSV                            = "additive-model-results/matmul/estimated_matrix_multiplication_Energy_median.csv"
# LOGISTIC_FUNCTION_ESTIMATED_ENERGY_CSV                 = "additive-model-results/logistic_function/estimated_logistic_function_Energy_median.csv"
# SIGN_EVAL_ESTIMATED_ENERGY_CSV                         = "additive-model-results/sign_eval/estimated_sign_eval_Energy_median.csv"

# RESNET_ESTIMATED_RUNTIME_CSV                            = "additive-model-results/resnet/estimated_low_memory_resnet20_Time_median.csv"
# LOGISTIC_REGRESSION_ESTIMATED_RUNTIME_CSV               = "additive-model-results/logreg/estimated_logistic_regression_Time_median.csv"
# CIFAR_10_ESTIMATED_RUNTIME_CSV                          = "additive-model-results/cifar10/estimated_cifar10_Time_median.csv"
# CHI_SQUARE_ESTIMATED_RUNTIME_CSV                        = "additive-model-results/chi-square/estimated_chi_square_test_Time_median.csv"

# RESNET_ESTIMATED_ENERGY_CSV                            = "additive-model-results/resnet/estimated_low_memory_resnet20_Energy_median.csv"
# LOGISTIC_REGRESSION_ESTIMATED_ENERGY_CSV               = "additive-model-results/logreg/estimated_logistic_regression_Energy_median.csv"
# CIFAR_10_ESTIMATED_ENERGY_CSV                          = "additive-model-results/cifar10/estimated_cifar10_Energy_median.csv"
# CHI_SQUARE_ESTIMATED_ENERGY_CSV                        = "additive-model-results/chi-square/estimated_chi_square_test_Energy_median.csv"
...
# MATMUL_PRIMITIVE_CONTRIBUTION_CSV               = "function-breakdowns/matmul.csv"
# LOGISTIC_FUNCTION_PRIMITIVE_CONTRIBUTION_CSV    = "function-breakdowns/logistic_function.csv"
# SIGN_EVALUATION_CONTRIBUTION_CSV                = "function-breakdowns/sign_eval.csv"
# RESNET_PRIMITIVE_CONTRIBUTION_CSV               = "function-breakdowns/resnet.csv"
# LOGISTIC_REGRESSION_PRIMITIVE_CONTRIBUTION_CSV  = "function-breakdowns/logreg.csv"
# CIFAR10_PRIMITIVE_CONTRIBUTION_CSV              = "function-breakdowns/cifar10.csv"
# CHI_SQUARE_PRIMITIVE_CONTRIBUTION_CSV           = "function-breakdowns/chi_square_test.csv"
...
# AMD_TIME_ORIGINAL_ALGO_CSV                      = "additive-model-results/figure_11/amd_estimated_runtime_matmul_original_algo_median.csv"
# AMD_TIME_NEW_ALGO_CSV                           = "additive-model-results/figure_11/amd_estimated_runtime_matmul_new_algo_median.csv"
# AMD_ENERGY_ORIGINAL_ALGO_CSV                    = "additive-model-results/figure_11/amd_estimated_energy_matmul_original_algo_median.csv"
# AMD_ENERGY_NEW_ALGO_CSV                         = "additive-model-results/figure_11/amd_estimated_energy_matmul_new_algo_median.csv"
...
# INTEL_TIME_ORIGINAL_ALGO_CSV                    = "additive-model-results/figure_11_intel/estimated_intel_matmul_original_algo_Time_median.csv"
# INTEL_TIME_NEW_ALGO_CSV                         = "additive-model-results/figure_11_intel/estimated_intel_matmul_new_algo_Time_median.csv"
# INTEL_ENERGY_ORIGINAL_ALGO_CSV                  = "additive-model-results/figure_11_intel/estimated_intel_matmul_original_algo_Energy_median.csv"
# INTEL_ENERGY_NEW_ALGO_CSV                       = "additive-model-results/figure_11_intel/estimated_intel_matmul_new_algo_Energy_median.csv"
...
def figure_8_primitive_hardware_backend_curve_ring_sweep(ax1, tag, set_legend, df, platform: str, primitives: List[str], metric: str = "Time", output_dir: str = OUTPUT_DIR) -> None:
    ...
    # Calculate and print max and average speedup across all ring dimensions
    speedups = []
    for idx, primitive in enumerate(primitives):
        df_hexl_false = df[df["hexl"] == False] if "hexl" in df.columns else df
        df_hexl_true = df[df["hexl"] == True] if "hexl" in df.columns else df
...
def figure_10_relative_error_application_curve_thread_sweep(ax, tag, set_legend, platform: str, benchmarks: List[str], sec_std: str, n: int, depth: int, thread_counts: List[int], metric: str = "Time", output_dir: str = OUTPUT_DIR) -> None:
    ...
    global relative_percentage_errors
    ...
    for benchmark in benchmarks:
        ...
        for thread_count in thread_counts:
            ...
            if len(filtered_est_df) == 0:
                print(f"No estimated values for {benchmark} with sec_std={sec_std}, n={n}, depth={depth}, num_threads={thread_count}")
                # exit()
            ...
            if len(filtered_actual_df) == 0:
                print(f"No actual values for {benchmark} with sec_std={sec_std}, n={n}, depth={depth}, num_threads={thread_count}")
                # exit()
    ...
    for benchmark in benchmarks:
        ax.plot(x_positions, relative_percentage_errors[benchmark].values(), label=application_label_map[benchmark])
    ...
    for thread_count in thread_counts:
        ...
        microbenchmark_mean_thread.append(np.power(np.prod(np.abs(microbenchmarks_errors)), 1/len(microbenchmarks_errors)) * np.sign(np.mean(microbenchmarks_errors)))
        workload_mean_thread.append(np.power(np.prod(np.abs(workloads_errors)), 1/len(workloads_errors)) * np.sign(np.mean(workloads_errors)))
    
    # print(microbenchmark_mean_thread)
    # print(workload_mean_thread)
    # Calculate geometric means
    # Geometric mean calculated as (x1 * x2 * ... * xn)^(1/n)
    microbenchmark_mean = np.power(np.prod(np.abs(all_microbenchmark_errors)), 1/len(all_microbenchmark_errors)) * np.sign(np.mean(all_microbenchmark_errors))
    workload_mean = np.power(np.prod(np.abs(all_workload_errors)), 1/len(all_workload_errors)) * np.sign(np.mean(all_workload_errors))
    print(f"metric: {metric}")
    print(f"Microbenchmark Geometric Mean: {microbenchmark_mean:.2f}%")
    print(f"Workload Geometric Mean: {workload_mean:.2f}%")
    print()
    # Plot lines for the geometric means of microbenchmarks and workloads
    # ax.axhline(y=microbenchmark_mean, color='black', linestyle='--', linewidth=2, label='Microbenchmark geomean')
    # ax.axhline(y=workload_mean, color='gray', linestyle=':', linewidth=2, label='Workload geomean')
...
def figure_11_primitive_breakdown_application_sweep(ax, tag, set_legend, platform: str, sec_std: str, ring_dim: int, batch_size: int, depth: int, num_threads: int, benchmarks: List[str], primitives: List[str], metric: str = "Time", output_dir: str = OUTPUT_DIR) -> None:
    ...
    for benchmark, csv_path in contributions_dict["estimated"].items():
        ...
        if len(filtered_df) == 0:
            print(f"No estimated values for {benchmark} with sec_std={sec_std}, n={ring_dim}, depth={depth}, num_threads={num_threads}")
            exit()
...
def main():
    ...
    amd_microbench_sec_std_df = pd.read_csv(AMD_MICROBENCH_SEC_STD_CSV)
    ...
    amd_primitive_sec_std_df = pd.read_csv(AMD_PRIMITIVE_SEC_STD_CSV)
    amd_workload_df = pd.read_csv(AMD_WORKLOAD_CSV)
    amd_resnet_df = pd.read_csv(AMD_RESNET_CSV)
    amd_primitives_hardware_backend_df = pd.read_csv(AMD_PRIMITIVES_HARDWARE_BACKEND_CSV)
    intel_microbench_sec_std_df = pd.read_csv(INTEL_MICROBENCH_SEC_STD_CSV)
    intel_microbench_no_sec_std_df = pd.read_csv(INTEL_MICROBENCH_NO_SEC_STD_CSV)
    intel_primitive_no_sec_std_runtime_df = pd.read_csv(INTEL_PRIMITIVE_NO_SEC_STD_RUNTIME_CSV)
    intel_primitive_event_df = pd.read_csv(INTEL_PRIMITIVE_EVENT_CSV)
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_5_ad.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_6_ad.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_7_ad.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_8_ab.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_9_ad.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_10_ab.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_11_ab.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
    ...
    plt.savefig(f"{OUTPUT_DIR}/figure_12.pdf", bbox_inches='tight', pad_inches=0)
    plt.close()
